...
<div class="page-container">
	...
	<div class="form-card">
		<form action="<?php echo appUrl('/routes/traiter_promotion.php'); ?>" method="POST" class="form">
			...
			<div class="form-group">
				...
				<input type="number" id="nombreEtudiants" name="nombreEtudiants" class="form-input" placeholder="ex: 45" min="1" required>
			</div>
